...
CREATE TABLE `tb_mq_message` (
  `id` bigint(20) NOT NULL COMMENT '消息ID，用作 CorrelationData',
  `biz_type` varchar(64) NOT NULL COMMENT '业务类型，例如 SECKILL_ORDER',
  `biz_id` bigint(20) NOT NULL COMMENT '业务ID，例如 orderId',
  ...
  `retry_count` int(11) NOT NULL DEFAULT 0 COMMENT '补偿重试次数',
...
-- ----------------------------
-- Table structure for tb_order_timeout_close_fail
-- ----------------------------
...
-- Table structure for tb_order_timeout_close_fail
-- ----------------------------
DROP TABLE IF EXISTS `tb_order_timeout_close_fail`;
CREATE TABLE `tb_order_timeout_close_fail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `user_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '用户id',
  `voucher_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '秒杀券id',
