...
public class RedisConstants {
    ...
    public static final String SECKILL_PENDING_DETAIL_KEY = "seckill:pending:detail:";
    ...
    public static final String ORDER_TIMEOUT_SCAN_LOCK_KEY = "lock:order:timeout:scan";
